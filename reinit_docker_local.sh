...
docker run --name practise_mysql -e MYSQL_ROOT_PASSWORD=root@lab3 -p 43306:3306  -d mysql:8.0
docker run --name practise_postgres -e POSTGRES_PASSWORD=root@lab3 -p 43307:5432 -d postgres:14

docker run --name learncase_mysql -e MYSQL_ROOT_PASSWORD=root@lab3 -p 53306:3306  -d mysql:8.0
docker run --name learncase_postgres -e POSTGRES_PASSWORD=root@lab3 -p 53307:5432 -d postgres:14


docker run --name learnsql_mysql -e MYSQL_ROOT_PASSWORD=root@lab3 -p 33062:3306  -d mysql:8.0
docker run --name learnsql_postgres -e POSTGRES_PASSWORD=root@lab3 -p 33063:5432 -d postgres:14
